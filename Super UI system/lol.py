...
def main_function():
    ...
    def time_clock():
        ...
        def stopwatch_def():
            ...
            def stop_def():
                pass
            tl = Label(main, text = "STOPWATCH", bg = mc, font = ('calibri', 30), fg = '#0F9D58')
            tl.place(x = 400, y = 100)
            start_b = Button(main,text = "Start", bg = mc, activebackground = mc, font = ("cambria", 20),
            command = start_def)
        ...
        stop_b = Button(main, text = "Stopwatch", bg = mc, activebackground = mc,
        font = ('calibri', 10), command = stopwatch_def)
        stop_b.place(x = 800, y = 100)
